...
function AboutMe() {
  return (
    ...
    >
      ...
      >
        Hello! I'm a full stack developer currently working for a startup based
        in the US. But I live a few thousand miles away here in London. Most of
        my work involves designing and implementing reusable and extendable
        components and working with an ever growing team of developers. I am
        always open to new collaborations and a chat about my career change.
